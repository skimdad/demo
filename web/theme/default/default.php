...
<link href="<?=THEMEFILE_URL;?>/default/structure.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/structure.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>
...
<link href="<?=THEMEFILE_URL;?>/default/members.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/members.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>
...
<link href="<?=THEMEFILE_URL;?>/default/popup.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/popup.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>
...
<link href="<?=THEMEFILE_URL;?>/default/front.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/front.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>
...
<link href="<?=THEMEFILE_URL;?>/default/blog.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/blog.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>

<? if (string_strpos($_SERVER['PHP_SELF'], BLOG_FEATURE_FOLDER."/sitemgr/blog/preview.php") !== false){ ?>
<link href="<?=THEMEFILE_URL;?>/default/advertise.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/advertise.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>
...
<link href="<?=THEMEFILE_URL;?>/default/order.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/order.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>
...
<link href="<?=THEMEFILE_URL;?>/default/results.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/results.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>

<? if ((string_strpos($_SERVER['PHP_SELF'], "detail.php") !== false) && (!string_strpos($_SERVER['PHP_SELF'], BLOG_FEATURE_FOLDER."/detail.php") !== false)) { ?>
<link href="<?=THEMEFILE_URL;?>/default/detail.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/detail.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>
...
<link href="<?=THEMEFILE_URL;?>/default/profile.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/profile.css" rel="stylesheet" type="text/css" media="all" />
<? } ?>

<link href="<?=THEMEFILE_URL;?>/default/content_custom.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?=THEMEFILE_URL;?>/default/schemes/<?=$scheme_path?>/content_custom.css" rel="stylesheet" type="text/css" media="all" />

<link href="<?=THEMEFILE_URL;?>/default/print.css" rel="stylesheet" type="text/css" media="print" />
