<?
	 ...
	 * @param object $dbObj
	 */
	function import_generateSQLLot($importID, &$dbObj, $type = "listing") {
		/*
				...
				if ($i > 0) {
					if (strlen($sqlBlock) == 0 && strlen($sqlLine) == 0) {
						if ($type != "listing"){ //working only for Event
							$sqlLine = "INSERT INTO `ImportTemporary_".ucfirst($type)."` (`id`, `import_log_id`, `file_line_number`, `account_username`, `account_password`, `account_first_name`, `account_last_name`, `account_company`, `account_address`, `account_address2`, `account_country`, `account_state`, `account_city`, `account_zip`, `account_phone`, `account_fax`, `account_email`, `account_url`, `legacy_id`, `".$type."_id`, `".$type."_title`, `".$type."_email`, `".$type."_url`, `".$type."_address`, `".$type."_locationname`, `".$type."_contactname`, `".$type."_startdate`, `".$type."_enddate`, `".$type."_starttime`, `".$type."_starttime_mode`, `".$type."_endtime`, `".$type."_endtime_mode`, `".$type."_location1`, `".$type."_location1_abbreviation`, `".$type."_location2`, `".$type."_location2_abbreviation`, `".$type."_location3`, `".$type."_location3_abbreviation`, `".$type."_location4`, `".$type."_location4_abbreviation`, `".$type."_location5`, `".$type."_location5_abbreviation`, `".$type."_zip`, `".$type."_latitude`, `".$type."_longitude`, `".$type."_phone`, `".$type."_description`, `".$type."_long_description`, `".$type."_keyword`, `".$type."_updated_date`, `".$type."_renewal_date`, `".$type."_status`, `".$type."_level`, `".$type."_category_1`, `".$type."_category_2`, `".$type."_category_3`, `".$type."_category_4`, `".$type."_category_5`) VALUES ";
						} else {
