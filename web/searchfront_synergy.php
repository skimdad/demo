...
$debug_geoIP = false;
	...
	<form class="form" name="search_form" id="search_form" method="<?=$method?>"  onSubmit="submitformSearch('<?=$action?>');">
				<div><input type="checkbox" name="check_deals" id="check_deals" value="deal"  class="checkbox" onClick="document.getElementById('check_all').checked = false;" <?php if ($_REQUEST['check_deals'] != '') echo "checked"; ?>/>Deals&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="check_list" id="check_list" value="listing" class="checkbox" onClick="document.getElementById('check_all').checked = false;" <?php if ($_REQUEST['check_list'] != '') echo "checked"; ?>/>Businessess&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="check_class" id="check_class" value="classified" class="checkbox" onClick="document.getElementById('check_all').checked = false;" <?php if ($_REQUEST['check_class'] != '') echo "checked"; ?>/>Classifieds<br />
				<input type="checkbox" name="check_events" id="check_events" value="events"  class="checkbox" onClick="document.getElementById('check_all').checked = false;" <?php if ($_REQUEST['check_events'] != '') echo "checked"; ?>/>Events&nbsp;&nbsp;
				<input type="checkbox" name="check_articles" id="check_articles" value="articles" class="checkbox" onClick="document.getElementById('check_all').checked = false;" <?php if ($_REQUEST['check_articles'] != '') echo "checked"; ?>/>Articles&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="check_all" id="check_all" value="all" class="checkbox" <?php if ($_REQUEST['check_all'] != '' || ($_REQUEST['check_deals']== '' && $_REQUEST['check_list'] == '' && $_REQUEST['check_class'] == '' && $_REQUEST['check_events'] == '' && $_REQUEST['check_articles'] == '')) echo "checked"; ?> onClick="document.getElementById('check_deals').checked = false;document.getElementById('check_list').checked = false;document.getElementById('check_class').checked = false; document.getElementById('check_events').checked = false;document.getElementById('check_articles').checked = false;"/>All
	</div>
	<div id="search">
...
$("#where").change(function() {
    ...
    $.ajax({
            ...
            <? if (!$keepFormOpen) { ?>
                ...
                <div class="left">
                    <!--
					Doesn't work on FF/Chrome
					<button type="button" id="buttonSearch" onclick="submitformSearch('<?=$action?>');"><?=system_showText(LANG_BUTTON_SEARCH);?>-->
					<button type="button" id="buttonSearch"><?=system_showText(LANG_BUTTON_SEARCH);?>
					</button>
