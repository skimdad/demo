...
class EpiOAuth
{
  ...
  protected function generateSignature($method = null, $url = null, $params = null)
  {
    ...
    $concatenatedParams = $this->encode(string_substr($concatenatedParams, 0, -1));
  ...
  {
    $urlParts = parse_url($url);
    $scheme = string_strtolower($urlParts['scheme']);
    $host   = string_strtolower($urlParts['host']);
