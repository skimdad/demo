...
//			$dbMain->close();
			...
			$body_sitemgr_msg .= "
							...
							<br />\n<br />\n
							<b>Status:</b> <b style=\"color:#003365\">".$sitemgrmsgstatus."</b>
							<br />\n
							<b>Account:</b> ".system_showAccountUserName($this->username)."
							<br />\n
							<b>Transaction ID:</b> ".$this->transaction_id."
							<br />\n
							<b>Transaction Time:</b> ".format_date($this->transaction_datetime, DEFAULT_DATE_FORMAT, "datetime")." - ".format_getTimeString($this->transaction_datetime)."
							<br />\n
							<b>IP:</b> ".$this->ip."
							<br />\n
							<b>Subtotal:</b> ".$this->transaction_subtotal." (".$this->transaction_currency.")
							<br />\n
							<b>Tax:</b> ".payment_calculateTax($this->transaction_subtotal,$this->transaction_tax,true,false)." (".$this->transaction_currency.")
							<br />\n
							<b>Amount:</b> ".$this->transaction_amount." (".$this->transaction_currency.")
							<br />\n
							<b>Gateway:</b> ".ucfirst($this->system_type)."
				";
			if ($this->recurring == "y") {
				$body_sitemgr_msg .= "
			...
			if (!empty($listings[0])) {
				...
				foreach ($listings as $each_listing) {
					...
					$sitemgr_link[] = "<a href=\"".$domain_url."/sitemgr/".LISTING_FEATURE_FOLDER."/view.php?id=".$each_listing["listing_id"]."\" target=\"_blank\">".string_ucwords(LISTING_FEATURE_NAME).": ".$each_listing["listing_title"]."</a><br />\n";
			...
			if (!empty($events[0])) {
				...
				foreach ($events as $each_event) {
					...
					$sitemgr_link[] = "<a href=\"".$domain_url."/sitemgr/".EVENT_FEATURE_FOLDER."/view.php?id=".$each_event["event_id"]."\" target=\"_blank\">".string_ucwords(EVENT_FEATURE_NAME).": ".$each_event["event_title"]."</a><br />\n";
			...
			if (!empty($banners[0])) {
				...
				foreach ($banners as $each_banner) {
					...
					$sitemgr_link[] = "<a href=\"".$domain_url."/sitemgr/".BANNER_FEATURE_FOLDER."/view.php?id=".$each_banner["banner_id"]."\" target=\"_blank\">".string_ucwords(BANNER_FEATURE_NAME).": ".$each_banner["banner_caption"]."</a><br />\n";
			...
			if (!empty($classifieds[0])) {
				...
				foreach ($classifieds as $each_classified) {
					...
					$sitemgr_link[] = "<a href=\"".$domain_url."/sitemgr/".CLASSIFIED_FEATURE_FOLDER."/view.php?id=".$each_classified["classified_id"]."\" target=\"_blank\">".string_ucwords(CLASSIFIED_FEATURE_NAME).": ".$each_classified["classified_title"]."</a><br />\n";
			...
			if (!empty($articles[0])) {
				...
				$body_sitemgr_msg .= "
							...
							<table cellpadding=\"2\" cellspacing=\"2\" border=\"0\">
								<tr>
									<td><b>Title</b></td>
									<td><b>Level</b></td>
									<td><b>".system_showText(LANG_LABEL_DISCOUNTCODE)."</b></td>
									<td><b>Renewal Date</b></td>
									<td><b>Amount (".$this->transaction_currency.")</b></td>
								</tr>\n
					";
				...
				foreach ($articles as $each_article) {
					...
					$sitemgr_link[] = "<a href=\"".$domain_url."/sitemgr/".ARTICLE_FEATURE_FOLDER."/view.php?id=".$each_article["article_id"]."\" target=\"_blank\">".string_ucwords(ARTICLE_FEATURE_NAME).": ".$each_article["article_title"]."</a><br />\n";
			...
			if (!empty($custominvoices[0])) {
				...
				foreach ($custominvoices as $each_custominvoice) {
					...
					$sitemgr_link[] = "<a href=\"".$domain_url."/sitemgr/custominvoices/view.php?id=".$each_custominvoice["custom_invoice_id"]."\" target=\"_blank\">Custom Invoice: ".$each_custominvoice["title"]."</a><br />\n";
			...
			if (!empty($packages[0])) {
				...
				foreach ($packages as $each_package) {
					...
					$sitemgr_link[] = "<a href=\"".$domain_url."/sitemgr/package/view.php?id=".$each_package["package_id"]."\" target=\"_blank\">Package: ".$each_package["package_title"]."</a><br />\n";
