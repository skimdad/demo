		...
		function Save() {
			...
			if ($this->has_account) {
				...
				$sql = "INSERT INTO AccountProfileContact"
					. " (account_id, first_name, last_name, nickname, friendly_url, image_id, facebook_image, facebook_image_width, facebook_image_height, has_profile)"
					. " VALUES"
					. " ($this->account_id, $this->first_name, $this->last_name, $this->nickname, $this->friendly_url, $this->image_id, $this->facebook_image, $this->facebook_image_width, $this->facebook_image_height, $this->has_profile)";
