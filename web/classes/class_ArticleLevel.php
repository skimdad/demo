<?
	...
	class ArticleLevel {
		...
		function ArticleLevel($lang=EDIR_DEFAULT_LANGUAGE, $listAll = false, $domain_id = false) {
		...
		function getContent($value) {
			...
			unset($dbMain);
			$sql   = "SELECT content FROM ArticleLevel_Lang WHERE value='$value' AND lang='$this->lang' AND theme = ".db_formatString(EDIR_THEME ? EDIR_THEME : "default")."";
			$result = $dbObj->query($sql);
