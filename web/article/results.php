<?
	...
	//Zip not applicable to articles
	...
	if ($review_article_enabled && $commenting_edir && $numberOfReviews){
		$orderBy =  array(LANG_PAGING_ORDERBYPAGE_REVIEWS,LANG_PAGING_ORDERBYPAGE_AZ,LANG_PAGING_ORDERBYPAGE_DATECREATED);
	} else {
		$orderBy =  array(LANG_PAGING_ORDERBYPAGE_AZ,LANG_PAGING_ORDERBYPAGE_DATECREATED);
	}
