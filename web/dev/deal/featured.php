						...
						echo "<div class=\"$contentClass\">";
							...
							if (!$listing["title"]) {
								for ($dealcount = 2; $dealcount <= 5; $dealcount++) {
									$listing = db_getFromDB("listing", "promotion_id_" . $dealslot[$dealcount], db_formatNumber($promotion->getNumber("id")), 1, "", "array");
									if ($listing["title"])
										break;
								}
							}
