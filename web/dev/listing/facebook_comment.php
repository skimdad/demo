<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /listing/facebook_comment.php
	# ----------------------------------------------------------------------------------------------------
	...
	if ($id) {
		...
		if (MODREWRITE_FEATURE == "on") {
			$sbmLink = LISTING_DEFAULT_URL."/".$friendly_url.".html?fb_comment_id=".$_GET["fb_comment_id"];
		} else {
			$sbmLink = LISTING_DEFAULT_URL."/detail.php?id=".$id."&fb_comment_id=".$_GET["fb_comment_id"];
		 }
		...
		$image_id = $listingObj->getNumber("image_id");
