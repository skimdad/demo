<?
            ...
            <html>
                ...
                <body>
                    <div class=\"email_style_settings\">"
                        ...
                        ."<a href=\"".DEFAULT_URL."/sitemgr/review\" target=\"_blank\">".DEFAULT_URL."/sitemgr/review</a><br /><br />"
                    ."</div>
                </body>
            </html>";
    ...
    header('Location: ' . DEFAULT_URL . '/members/review/index.php?item_type=' . $_GET['item_type'] . '&item_id=' . $_GET['item_id'] . $response);
?>