<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /members/deal/getMoreResults.php
	# ----------------------------------------------------------------------------------------------------
	...
	$url_base = "".DEFAULT_URL."/members/".PROMOTION_FEATURE_FOLDER."/view";
	$members = 1;
	...
	$url_redirect = "".DEFAULT_URL."/members/".PROMOTION_FEATURE_FOLDER."/view";
	if ($searchFor) {
		$pageObj = new pageBrowsing("Promotion_Redeem", $screen, $search_limit, "id DESC", false, false, "promotion_id = $promotion_id".$where, "*", false, false, false, SELECTED_DOMAIN_ID);
