<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /members/sitemgraccess.php
	# ----------------------------------------------------------------------------------------------------
	...
	if (!empty($_SESSION[SM_LOGGEDIN])) {
		...
		if ($_GET["action"] == 'profile') {
			...
			if (MODREWRITE_FEATURE == 'on') {
				$profileLink = SOCIALNETWORK_URL."/".$profile->getString("friendly_url").".html";
			} else {
				$profileLink = SOCIALNETWORK_URL."/index.php?id=".$profile->getString("account_id")."";
			}
