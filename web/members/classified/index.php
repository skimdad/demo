<?
	...
	$pageObj = new pageBrowsing("Classified", $screen, RESULTS_PER_PAGE, (($_GET["newest"])?("id DESC"):("level, title")), "title", $letter, $where);
	$classifieds = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/members/".CLASSIFIED_FEATURE_FOLDER."/index.php";
								...
								<tr>
									<td width="50%">
										<table align="center" border="0" cellpadding="0" cellspacing="0" class="warningBOX">
											<tr>
												<th><a href="<?=DEFAULT_URL?>/members/billing/index.php" class="warningBOXcontent"><?=system_showText(LANG_MSG_CONTINUE_TO_PAY_CLASSIFIED)?></a></th>
