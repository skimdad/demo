	...
	if ($pay) {
		...
		if (isset($transaction_payflow["RESULT"])) {
			...
			if ($transaction_payflow["RESULT"] != "0") { // transaction failed.
				...
				if ($process == "signup") $try_again_message = "<a href=\"".DEFAULT_URL."/members/".$process."/payment.php?payment_method=payflow\">".system_showText(LANG_MSG_CLICK_HERE_TO_TRY_AGAIN)."</a>\n";
				elseif ($process == "claim") $try_again_message = "<a href=\"".DEFAULT_URL."/members/".$process."/payment.php?payment_method=payflow&claimlistingid=".$claimlistingid."\">".system_showText(LANG_MSG_CLICK_HERE_TO_TRY_AGAIN)."</a>\n";
			...
			$payment_message .= "<a href=\"".DEFAULT_URL."/members/billing/index.php\">".system_showText(LANG_MSG_CLICK_HERE_TO_TRY_AGAIN)."</a>\n</p>\n";
		}
