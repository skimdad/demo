...
<table cellpadding="2" cellspacing="0" class="table-contact">
	...
	<tr class="tr-contact">
		<td align="right" class="td-contact">
			<div class="label-contact">
				<?=system_showText(LANG_SITEMGR_LABEL_STATE)?> / <?=system_showText(LANG_SITEMGR_LABEL_CITY)?> / <?=string_ucwords(ZIPCODE_LABEL)?>:
			</div>
		</td>
		<td align="left" class="td-account">
			<span class="label-field-contact">
	...
	<tr class="tr-contact">
		...
		<td align="left" class="td-account">
			<span class="label-field-contact">
				<?
				echo $contact->getString("phone")." / ".system_showText(LANG_SITEMGR_LABEL_FAX).": ".$contact->getString("fax");
				?>
			</span>
		</td>
	</tr>
