...
<style>
        ...
        .btns a {
            height: 19px;
            width: 100px;
            background-image:url(http://www.dealcloudus/sitemgr/listing/images/btn.gif); background-repeat:repeat-x; color:#fff; text-align:center; text-decoration:none;
        ...
        .file_input_button {
            ...
            color: #FFFFFF;
            border-width:0px;
            background-image: url(http://www.dealcloudus/sitemgr/listing/images/btn.gif);
        ...
        #colorSelector {
            ...
            width: 36px;
            height: 36px;
            background: url(http://www.dealcloudus/sitemgr/listing/images/select.png);
        }
        #colorSelector div {
            position: absolute;
            top: 3px;
            ...
            width: 30px;
            height: 30px;
            background: url(http://www.dealcloudus/sitemgr/listing/images/select.png) center;
        }
