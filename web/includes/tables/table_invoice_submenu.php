<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/tables/table_invoice_submenu.php
	# ----------------------------------------------------------------------------------------------------
...
$openPMedit = (isset($id)&& $id!="") && (!string_strpos($_SERVER["PHP_SELF"], "view"));
?>

<div class="submenu">
	<ul>
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/sitemgr/invoices/index.php"><?=system_showText(LANG_SITEMGR_MENU_HISTORY)?></a></li>
		<li id="privateMenu_search"><a href="<?=DEFAULT_URL?>/sitemgr/invoices/search.php"><?=system_showText(LANG_SITEMGR_MENU_SEARCH)?></a></li>
