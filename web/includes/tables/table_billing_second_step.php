	...
	<? if (!$stop_payment) { ?>
		...
		if (($payment_method == "invoice") && (INVOICEPAYMENT_FEATURE == "on")) {
            ...
            <p class="standardButton completeButton">
                <a href="<?=DEFAULT_URL?>/members/billing/invoice.php?id=<?=$bill_info["invoice_number"]?>" class="iframe fancy_window_invoice"><?=system_showText(LANG_LABEL_PAY_BY_INVOICE);?></a>
            </p>
			<?
		} else {
