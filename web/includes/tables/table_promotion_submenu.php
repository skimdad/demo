...
$openPMadd = ((string_strpos($_SERVER["PHP_SELF"], "deal.php"))&&(!string_strpos($_SERVER["REQUEST_URI"], "?id")))&&!(isset($id)&& $id!="");
$openPMsearch = string_strpos($_SERVER["PHP_SELF"], "search");
$openPMview = string_strpos($_SERVER["PHP_SELF"], "view");
$openPMedit = (isset($id)&& $id!="")&&!$openPMview && !string_strpos($_SERVER["PHP_SELF"], "search") && !string_strpos($_SERVER["PHP_SELF"], "index");
?>

<div class="submenu">
	<ul>
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/sitemgr/<?=PROMOTION_FEATURE_FOLDER;?>/index.php"><?=system_showText(LANG_SITEMGR_MANAGE)?></a></li>
		<li id="privateMenu_add"><a href="<?=DEFAULT_URL?>/sitemgr/<?=PROMOTION_FEATURE_FOLDER;?>/deal.php"><?=string_ucwords(system_showText(LANG_SITEMGR_MENU_ADD))?></a></li>
		<li id="privateMenu_search"><a href="<?=DEFAULT_URL?>/sitemgr/<?=PROMOTION_FEATURE_FOLDER;?>/search.php"><?=string_ucwords(system_showText(LANG_SITEMGR_MENU_SEARCH))?></a></li>
                <li><a href="<?=DEFAULT_URL?>/sitemgr/review/index.php?item_type=promotion"><?=system_showText(LANG_SITEMGR_MENU_REVIEWS)?></a></li>
