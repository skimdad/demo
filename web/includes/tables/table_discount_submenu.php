<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/tables/table_discount_submenu.php
	# ----------------------------------------------------------------------------------------------------

$openPMhome = string_strpos($_SERVER["PHP_SELF"], "index");
$openPMadd = ((string_strpos($_SERVER["PHP_SELF"], "discountcode/discountcode.php"))&&(!string_strpos($_SERVER["REQUEST_URI"], "?x_id")))&&!(isset($id)&& $id!="");
$openPMedit = (isset($x_id)&& $x_id!="")&&!$openPMadd;

?>

<div class="submenu">
	<ul>
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/sitemgr/discountcode/index.php"><?=system_showText(LANG_SITEMGR_MANAGE)?></a></li>
		<li id="privateMenu_add"><a href="<?=DEFAULT_URL?>/sitemgr/discountcode/discountcode.php"><?=system_showText(LANG_SITEMGR_MENU_ADD)?></a></li>
