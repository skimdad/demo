<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/tables/table_custominvoice_submenu.php
	# ----------------------------------------------------------------------------------------------------


$openPMhome = string_strpos($_SERVER["PHP_SELF"], "index");
$openPMadd = ((string_strpos($_SERVER["PHP_SELF"], "custominvoice.php"))&&(!string_strpos($_SERVER["REQUEST_URI"], "?id")))&&!(isset($id)&& $id!="");
...
<div class="submenu">
	<ul>
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/sitemgr/custominvoices/index.php"><?=system_showText(LANG_SITEMGR_MANAGE)?></a></li>
		<li id="privateMenu_add"><a href="<?=DEFAULT_URL?>/sitemgr/custominvoices/custominvoice.php"><?=system_showText(LANG_SITEMGR_MENU_ADD)?></a></li>
		<li id="privateMenu_search"><a href="<?=DEFAULT_URL?>/sitemgr/custominvoices/search.php"><?=system_showText(LANG_SITEMGR_SEARCH)?></a></li>
