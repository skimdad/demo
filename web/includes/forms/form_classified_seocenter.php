...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		for (j=0;j<arrLangNumbers.length;j++) {
			i = arrLangNumbers[j];
			var field_name = 'seo_summarydesc'+i;
			var count_field_name = 'seo_summarydesc_remLen'+i;
...
<table cellpadding="0" cellspacing="0" border="0" class="standard-table noMargin">
	...
	<tr id="description_<?=$i?>" <?=($k == 0) ? "style=\"display:table-row;\"" : "style=\"display:none;\""?> >
		<td colspan="2">
			<textarea id="seo_summarydesc<?=$labelsuffix;?>" name="seo_summarydesc<?=$labelsuffix;?>" rows="5" cols="1"><?=${"seo_summarydesc".$labelsuffix};?></textarea>
