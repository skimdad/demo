<?
	...
	if (WORLDPAYPAYMENT_FEATURE == "on") {
		...
		if (!WORLDPAY_INSTID) {
			echo "<p class=\"errorMessage\">".system_showText(LANG_WORLDPAY_NO_AVAILABLE)." <a href=\"".DEFAULT_URL."/members/help.php\" class=\"billing-contact\">".system_showText(LANG_LABEL_ADMINISTRATOR)."</a>.</p>";
		} else {
			...
			$worldpay_callback = str_replace("http://", "", str_replace("https://", "", DEFAULT_URL))."/members/billing/callback.php";
			...
			<form name="worldpayform" target="_self" action="<?=WORLDPAY_HOST?>" method="post">
				...
				<div style="display: none;">
					...
					<input type="hidden" name="MC_edirurl"  value="<?=str_replace("http://", "", str_replace("https://", "", DEFAULT_URL))."/members/".$payment_process."/processpayment.php?payment_method=".$payment_method?>" />
				...
				<table align="center" width="95%" cellpadding="2" cellspacing="2" class="standard-table">
					<tr>
						<th colspan="2" class="standard-tabletitle"><?=system_showText(LANG_LABEL_CUSTOMER_INFO)?></th>
					</tr>
					<tr>
				...
				<? if ($payment_process == "signup") { ?>
					<table width="100%" border="0" cellpadding="2" cellspacing="2">
						<tr>
							<td><p class="standardButton paymentButton"><a href="javascript:void(0);" id="worldpaybutton" onclick="submitOrder();"><?=system_highlightWords(system_showText(LANG_LABEL_PLACE_ORDER_CONTINUE))?></a></p></td>
						</tr>
					</table>
				<? } else { ?>
