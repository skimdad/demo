<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/forms/form_event_seocenter.php
	# ----------------------------------------------------------------------------------------------------
...
<table cellpadding="0" cellspacing="0" border="0" class="standard-table">
	...
	<tr>
		<td colspan="2" class="standard-tableContent">
			<?=system_showText(LANG_MSG_FRIENDLY_URL1)?><br /><br /><strong><?=system_showText(LANG_LABEL_FOR_EXAMPLE)?>:</strong><br /><br /><?=system_showText(LANG_MSG_FRIENDLY_URL2)?><br />"<?=EVENT_DEFAULT_URL?>/john-auto-repair.html"
		</td>
	</tr>
	<tr>
