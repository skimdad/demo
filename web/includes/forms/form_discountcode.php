...
<table border="0" cellpadding="2" cellspacing="0" class="standard-table">
	...
	<tr>
		...
		<td><input type="text" name="expire_date" id="expire_date" value="<?=$expire_date?>" class="input-form-discountcode" style="width:100px" maxlength="10" /><span class="label-field-form">(<?=format_printDateStandard()?>)</span></td>
	</tr>
	<? if ($x_id) { ?>
		<tr>
		...
		<td>
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td style="color: #003365;"><?=system_showText(string_strtolower(LANG_SITEMGR_YES))?></td>
					<td class="td-checkbox"><input type="radio" name="recurring" value="no" class="inputCheck" <?=((!$recurring || $recurring == "no") ? "checked=true" : "")?> /></td>
					<td style="color: #003365;"><?=system_showText(string_strtolower(LANG_SITEMGR_NO))?></td>
