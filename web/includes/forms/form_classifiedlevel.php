...
<table border="0" cellpadding="0" cellspacing="0" class="levelTable">
    ...
    <tr>
		<th class="tableOption" colspan="2"><a href="<?=NON_SECURE_URL?>/advertise.php?classified" target="_blank"><?=system_showText(LANG_CLASSIFIED_OPTIONS);?></a></th>
	</tr>

	<tr>
	<?}?>

	<? if ((!$classified) || (($classified) && ($classified->needToCheckOut())) || (string_strpos($url_base, "/sitemgr")) || (($classified) && ($classified->getPrice() <= 0))) { ?>
