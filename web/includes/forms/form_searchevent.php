<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/forms/form_searchevent.php
	# ----------------------------------------------------------------------------------------------------
...
<table border="0" cellpadding="2" cellspacing="0" class="standard-table noMargin">
	...
	<tr>
		...
		<td><input type="text" name="search_title" value="<?=$search_title?>" class="input-form-searchevent" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
		&nbsp;<?=string_strtolower(system_showText(LANG_SITEMGR_LABEL_FROM))?>:&nbsp;
		<input type="text" name="search_date_period1" id="search_date_period1" value="<?=$search_date_period1?>" style="width:80px;" maxlength="10" />
		&nbsp;<?=string_strtolower(system_showText(LANG_SITEMGR_LABEL_TO2))?>:&nbsp;
		<input type="text" name="search_date_period2" id="search_date_period2" value="<?=$search_date_period2?>" style="width:80px;" maxlength="10" />
	...
	<? if ( PAYMENTSYSTEM_FEATURE == 'on' ) { ?>
		...
		<tr>
			...
			<td><input type="text" name="search_discount" value="<?=$search_discount?>" maxlength="10" class="input-form-searchevent" /></td>
		</tr>
...
<table border="0" cellpadding="2" cellspacing="0" class="standard-table">
	...
	<tr>
		...
		<td><input type="text" name="search_zipcode" value="<?=$search_zipcode?>" maxlength="10" class="input-form-searchevent" /></td>
	</tr>
