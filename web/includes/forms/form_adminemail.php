...
<table cellpadding="2" cellspacing="0" border="0" class="table-form">
	...
	<? if (BLOG_FEATURE == "on") { ?>
		<tr>
			<th class="table-formTitle"><b><?=system_showText(LANG_SITEMGR_SETTINGS_EMAIL_BLOG)?></b></th>
		</tr>
		<tr>
			<td>
				<table cellpadding="2" cellspacing="0">
					<tr>
						<th><?=system_showText(LANG_SITEMGR_LABEL_EMAIL)?>:</th>
						<td><input type="text" name="sitemgr_blog_email" value="<?=$sitemgr_blog_email?>" class="input-form-adminemail" style="width: 400px;" /></td>
					</tr>
				</table>
			</td>
		</tr>
	<? } ?>
	<tr>
		<th class="table-formTitle"><b><?=ucfirst(system_showText(LANG_SITEMGR_IMPORT))?></b></th>
	</tr>
	<tr>
		<td>
			<table cellpadding="2" cellspacing="0">
				<tr>
					<th><?=system_showText(LANG_SITEMGR_LABEL_EMAIL)?>:</th>
					<td><input type="text" name="sitemgr_import_email" value="<?=$sitemgr_import_email?>" class="input-form-adminemail" style="width: 400px;" /></td>
				</tr>
			</table>
		</td>
	</tr>
