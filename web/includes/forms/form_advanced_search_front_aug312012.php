<?
	...
	<div class="left match">
		...
		<div><input type="radio" name="match" value="allwords" class="radio" checked="yes" /> <?=system_showText(LANG_SEARCH_LABELMATCH_ALLWORDS)?></div>
