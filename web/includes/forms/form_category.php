...
<table cellpadding="0" cellspacing="0" border="0" class="standard-table noBlock">
	<tr>
	...
	<tr>
		...
		<td>
			<input type="checkbox" id="clickToDisable" name="clickToDisable" class="inputCheck" <?=($enabled == "on") ? "" : "checked" ?> onclick="enableCategory('<?=$num_languages?>');">
		</td>
	</tr>
	<? 
		$firstCheck = "";
                        ...
                        <table class="categoryExampleTable">
                            <tr>
                                <td class="categoryExampleLine">
                                    <p style="text-align: justify;"><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL1)?> <br /><br /><strong><?=system_showText(LANG_SITEMGR_FOREXAMPLE)?>:</strong> <br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL2)?><br />"<?=$default_url?>/guide/computer"<?=$table_category == "ListingCategory" ? "<br />\"".PROMOTION_DEFAULT_URL."/guide/computer\"" : ""?><br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL3)?><br />"<?=$default_url?>/guide/computer/software-development"<?=$table_category == "ListingCategory" ? "<br />\"".PROMOTION_DEFAULT_URL."/guide/computer/software-development\"" : ""?><br /><br /><?=system_showText(LANG_SITEMGR_CATEGORY_FRIENDLYURL4)?></p>
                                </td>
                            </tr>
                        </table>
					</td>
