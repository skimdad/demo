...
# ----------------------------------------------------------------------------------------------------
	...
	if (MODREWRITE_FEATURE == "on") {
		...
		$detailLink = MOBILE_DEFAULT_URL . "/classified_detail.php?id=" .$classified->getNumber("id");
	}
        $detailLink = MOBILE_DEFAULT_URL . "/classified_detail.php?id=" .$classified->getNumber("id");
/*
...
<div class="itemView classifiedView">
		...
		<? if ($price!= "NULL" &&$price) { ?>
			<p class="phone ui-li-desc"><span class="bold"><?=system_showText(LANG_LABEL_PRICE);?>:</span> <?=CURRENCY_SYMBOL.$price?></p>
		<? } ?>
		<? if ($phone ) { ?>
			<p class="phone ui-li-desc"><span class="bold"><?=system_showText(LANG_LISTING_LETTERPHONE);?>:</span> <?=$phone ?></p>
		<? } ?>
		<? if ($summaryDescription ) { ?>
			<p class="ui-li-desc"><?=$summaryDescription ?></p>
		<? } ?>
	</div>
</li>
