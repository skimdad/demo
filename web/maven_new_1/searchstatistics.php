<?
	...
	if ($item_total_amount > MAX_ITEM_PER_PAGE) {
		echo " <br /> ".system_showText(LANG_PAGING_SHOWINGPAGE)." <span class=\"bold\">".$page."</span> ".system_showText(LANG_PAGING_PAGEOF)." <span class=\"bold\">".ceil($item_total_amount/MAX_ITEM_PER_PAGE)."</span> ".LANG_PAGING_PAGE_PLURAL."";
	}
	echo "</p>";
