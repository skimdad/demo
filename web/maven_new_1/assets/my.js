...
$(document).bind( "pageinit", function( event, data ){ 
    ...
    $('#get_current_location').click(function(){
        ...
        if((typeof(locality) != 'undefined') && (typeof(state) != 'undefined') && (typeof(country) != 'undefined') )
        {
...
$(document).bind ('pageshow', function (e, data) {
    ...
    $("#where").change(function() {
        ...
        // alert(AUTOCOMPLETE_MINCHARS)
        if (where != ''){
            //alert(where);
            $.ajax({
                Type: "GET",
                url: "http://test.dealcloudusa.com/autocomplete_zip.php?where="+where,
