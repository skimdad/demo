...
*
* Copyright (c) 2007 Dylan Verheul, Dan G. Switzer, Anjesh Tuladhar, JÃÂ¶rn Zaefferer
*
...
break;case options.multiple&&$.trim(options.multipleSeparator)==","&&KEY.COMMA:case KEY.TAB:selectCurrent();select.hide();break;case KEY.RETURN:if(selectCurrent()){event.preventDefault();blockSubmit=true;return false;}
