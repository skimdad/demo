<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /sitemgr/blog/facebook.php
	# ----------------------------------------------------------------------------------------------------
	...
	if (!$commenting_fb){
		header("Location: ".DEFAULT_URL."/sitemgr/".BLOG_FEATURE_FOLDER."/".(($search_page) ? "search.php" : "index.php")."?message=".$message."&screen=$screen&letter=$letter".(($url_search_params) ? "&$url_search_params" : "")."");
		exit;
	}
...
<div id="main-right">
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<div id="header-view">
				<?=LANG_SITEMGR_BLOG_SING;?> <?=string_ucwords(system_showText(LANG_LABEL_FACEBOOK_COMMENTS))?> - <?=$post->getString("title")?>
			</div>
			...
			<div class="baseForm">
				...
				<form id="formfacebookcancel" action="<?=DEFAULT_URL?>/sitemgr/<?=BLOG_FEATURE_FOLDER;?>/<?=(($search_page) ? "search.php" : "index.php");?>" method="get">
