<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /sitemgr/blogcategs/index.php
	# ----------------------------------------------------------------------------------------------------
	...
	if (!isset($message)) system_setFreqActions('blogcateg_manage','BLOG_FEATURE');
	...
	$pageObj  = new pageBrowsing("BlogCategory", $screen, RESULTS_PER_PAGE, "title, id", $letterfield, $letter, "category_id = ".db_formatNumber($category_id), $fields);
	$categories = $pageObj->retrievePage("array");

	$paging_url = BLOG_DEFAULT_URL."/sitemgr/blogcategs/index.php?category_id=".$category_id;
...
<div id="main-right">
	...
	<div id="top-content">
		<div id="header-content">
			<h1><?=string_ucwords(system_showText(LANG_SITEMGR_BLOG_SING))?> - <?=string_ucwords(system_showText(LANG_SITEMGR_TAGS))?></h1>
		</div>
	</div>
	...
	<div id="content-content">
		...
		<div class="default-margin">
			...
			<? include(BLOG_INCLUDES_DIR."/tables/table_blogcategory.php"); ?>
			<? } ?>
		</div>
