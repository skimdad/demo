<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /event/allcategoriescontent.php
	# ----------------------------------------------------------------------------------------------------
	...
	if ($categories) {
		...
		for ($i=0; $i<count($categories); $i++) {
			...
			if (MODREWRITE_FEATURE == "on") {
				echo "<a href=\"".EVENT_DEFAULT_URL."/guide/".$categories[$i]["friendly_url".$langIndex]."\" title = \"".string_htmlentities($categories[$i]["title".$langIndex])."\">";
			} else {
				echo "<a href=\"".EVENT_DEFAULT_URL."/results.php?category_id=".$categories[$i]["id"]."\" title = \"".string_htmlentities($categories[$i]["title".$langIndex])."\">";
			}
