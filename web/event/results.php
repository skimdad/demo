<?
	...
	$orderBy =  array(LANG_PAGING_ORDERBYPAGE_EVENTDATE,LANG_PAGING_ORDERBYPAGE_DISTANCE,LANG_PAGING_ORDERBYPAGE_AZ);
	$orderbyDropDown = search_getOrderbyDropDown($_GET, $paging_url, $orderBy, system_showText(LANG_PAGING_ORDERBYPAGE)." ", "this.form.submit();", $parts,false,false,false,true);
	# --------------------------------------------------------------------------------------------------------------
