<?
	...
	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("Article", $screen, RESULTS_PER_PAGE, (($_GET["newest"])?("id DESC"):((ARTICLE_SCALABILITY_OPTIMIZATION == "on")?(""):("updated DESC, title"))), "title", $letter);
	$articles = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/sitemgr/".ARTICLE_FEATURE_FOLDER."/index.php";
...
<div id="main-right">
	<div id="top-content">
		<div id="header-content"><h1><?=string_ucwords(system_showText(LANG_SITEMGR_ARTICLE_PLURAL))?><? if (DEMO_MODE) { ?> <span>(Optional Module)</span> <? } ?></h1></div>
	</div>
