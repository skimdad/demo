<?
	...
	if ($id) {
		...
		header("Location: ".DEFAULT_URL."/sitemgr/locations/location_2/index.php?".($_location_node_params?$_location_node_params."&":"")."message=".$message."&screen=$screen&letter=$letter");
		exit;
	}
    ...
    <div id="main-right">
        ...
        <div id="content-content">
            <div class="default-margin">
                ...
                <form id="formlocation2deletecancel" action="<?=DEFAULT_URL?>/sitemgr/locations/location_2/index.php<?=($_location_node_params?"?".$_location_node_params."&":"?")?>operation=cancel" method="post">
                    <?=system_getFormInputHiddenParams((($_POST)?($_POST):($_GET)));?>
                </form>
