<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /sitemgr/locations/location_5/index.php
	# ----------------------------------------------------------------------------------------------------
	...
	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("Location_5", $screen, 50, "name, id", "name", $letter, ($aux_check_filter_option?"location_".$aux_available_level_filter."=".${"location_".$aux_available_level_filter}:false), "*", false, false, true);
	$locations = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/sitemgr/locations/location_5/index.php";
