<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /sitemgr/package/index.php
	# ----------------------------------------------------------------------------------------------------
	...
	if (!isset($message)) system_setFreqActions('package_manage','package builder');

	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("Package", $screen, RESULTS_PER_PAGE, "title", "title", $letter,"parent_domain=".SELECTED_DOMAIN_ID, "*", false, false, true);

	$packages = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/sitemgr/package/index.php";
