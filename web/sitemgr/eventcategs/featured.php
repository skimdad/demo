<?
	...
	$url_redirect = "".DEFAULT_URL."/sitemgr/eventcategs/featured.php";
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['save'] == 1) {
        ...
        $message = ucfirst(LANG_SITEMGR_FEATUREDEVENTSCATEGORIES_WERESUCCESSUPDATED);
    }
    ...
    $paging_url = DEFAULT_URL."/sitemgr/eventcategs/featured.php";
