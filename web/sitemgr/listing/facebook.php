<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /sitemgr/listing/facebook.php
	# ----------------------------------------------------------------------------------------------------
...
<div id="main-right">
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<div id="header-view">
				<?=system_showText(LANG_SITEMGR_LISTING_SING);?> <?=string_ucwords(system_showText(LANG_LABEL_FACEBOOK_COMMENTS))?> - <?=$listing->getString("title")?>
			</div>
			...
			<div class="baseForm">
				...
				<form id="formfacebookcancel" action="<?=DEFAULT_URL?>/sitemgr/<?=LISTING_FEATURE_FOLDER;?>/<?=(($search_page) ? "search.php" : "index.php");?>" method="get">
