<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /sitemgr/deal/facebook.php
	# ----------------------------------------------------------------------------------------------------
...
<div id="main-right">
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<div id="header-view">
				<?=LANG_SITEMGR_PROMOTION_SING;?> <?=string_ucwords(system_showText(LANG_LABEL_FACEBOOK_COMMENTS))?> - <?=$promotion->getString("name")?>
			</div>
			...
			<div class="baseForm">
				...
				<form id="formfacebookcancel" action="<?=DEFAULT_URL?>/sitemgr/<?=PROMOTION_FEATURE_FOLDER;?>/<?=(($search_page) ? "search.php" : "index.php");?>" method="get">
