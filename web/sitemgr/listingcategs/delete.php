<?
	...
	if ($id) {
        ...
        $message = 0;
		header("Location: ".DEFAULT_URL."/sitemgr/listingcategs/".(($search_page) ? "search.php" : "index.php")."?message=".$message."&category_id=".$category_id."&screen=$screen&letter=$letter".(($url_search_params) ? "&$url_search_params" : "")."");
		exit;
	}
...
<div id="main-right">
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<form id="formlistingcategorydeletecancel" action="<?=DEFAULT_URL?>/sitemgr/listingcategs/<?=(($search_page) ? "search.php" : "index.php");?>" method="get">
