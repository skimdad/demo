...
if ($location_map) :
    ...
    ?>
    <div data-role="content" style="padding: 15px;text-align: left;">
        <img  class="map-image" src="http://maps.google.com/maps/api/staticmap?center=<?= $location_map ?>&zoom=15&size=390x150&maptype=roadmap&mobile=true&markers=icon:<?= $icon ?>|<?= $location_map ?>&sensor=false" />
    </div>
<? endif; ?>
...
<!--<div data-role="content" style="padding: 0px;">
    ...
    <div id="map" class="map" style="width: 280px; height: 288px;margin:  0 auto">&nbsp;</div>
</div>-->
