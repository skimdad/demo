...
$promotionUrl = $mobile_base_url . 'index.php/' . $listing->id . '/promotion_detail/' . $promotionObj->id.'?show_redeem=true';
if(sess_getAccountIdFromSession()){
    $linkRedeem = $promotionUrl;
}
 else {
    $linkRedeem =  $mobile_base_url . 'index.php/' . $listing->id . '/login?redirecturl='.$promotionUrl;
}
