	...
	<div data-role="content" style="padding: 15px;">
             <a style="width: 100%" data-role="button" data-transition="fade" data-theme="c" href="<?= $mobile_base_url.'index.php/'.$listing->id.'/mydeal';?>" class="ui-btn-left">
    		My Deals
	     </a>
    ...
    <? else: ?>
<div data-role="content" style="padding: 15px;">
		       <? showErrorMsg($mobileAppObj->promotion_no_data); ?>
